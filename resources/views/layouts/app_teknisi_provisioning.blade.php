...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ request()->routeIs('teknisi_provisioning.dashboard') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('teknisi_provisioning.dashboard') }}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Dashboard</span>
                </a>
            </li>
            <div class="sidebar-heading">Divisi</div>
            <li class="nav-item {{ request()->routeIs('teknisi_provisioning.kegiatan') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('teknisi_provisioning.kegiatan') }}">
            ...
            <li class="nav-item {{ request()->routeIs('teknisi_provisioning.produktivitas') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('teknisi_provisioning.produktivitas') }}">
                    <i class="fas fa-check fa-fw"></i>
