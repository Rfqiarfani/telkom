...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ request()->routeIs('admin_assurance.dashboard') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin_assurance.dashboard') }}">
            ...
            <li class="nav-item {{ request()->routeIs('admin_assurance.management_akun_pengguna') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin_assurance.management_akun_pengguna') }}">
                    <i class="fas fa-user fa-fw"></i>
                    <span>Manajemen Akun Pengguna</span>
                </a>
            </li>
            <li class="nav-item {{ request()->routeIs('admin_assurance.management_data_aktivitas') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin_assurance.management_data_aktivitas') }}">
